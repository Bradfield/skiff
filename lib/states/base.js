...
class Base extends EventEmitter {
  ...
  _perhapsGrantVote (message) {
    ...
    // sender's (the candidate) has term that is equal or better than this node's term
    // and
    // candidate's term is better
    //  or this is first vote
    //  or previously voted for this candidate
    // and
    //  candidate has a the same log or a more current one
